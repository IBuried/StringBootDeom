...
public final class ProjectConstant {
    public static final String BASE_PACKAGE = "com.ssc.demo";//项目基础包名称，根据自己公司的项目修改

    public static final String MODEL_PACKAGE = BASE_PACKAGE + ".domain.db";//Model所在包
    public static final String MAPPER_PACKAGE = BASE_PACKAGE + ".jdbc";//Mapper所在包
